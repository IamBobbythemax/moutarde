                ...
                <div class="container">
                    <div class="row">
                        <div class="col d-flex flex-row">
                            ...
                            <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918597/mail.png" alt=""></div><a href="mailto:fastsales@gmail.com">mamoutarde@gmail.com</a></div>
                            <div class="top_bar_content ml-auto">
                                <div class="top_bar_menu">
                                    <ul class="standard_dropdown top_bar_dropdown">
                                        <li>
                                            <a href="#">Francais<i class="fas fa-chevron-down"></i></a>
                                            <ul>
                                                <li><a href="#">English</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">EUR €<i class="fas fa-chevron-down"></i></a>
                                            <ul>
                                                <!--<li><a href="#">US dollar $</a></li>
                                                <li><a href="#">Franc Suisse CHF</a></li>-->
                                ...
                                <div class="top_bar_user">
                                    ...
                                    <div class="user_icon"><img src="https://res.cloudinary.com/dxfq3iotg/image/upload/v1560918647/user.svg" alt=""></div>
                                    <!--<div><a href="inscription.php">Bonjour <//?= $_SESSION['prenom'];?></a></div>-->
                                    <div class="top_bar_menu">
                                    <ul class="standard_dropdown top_bar_dropdown">
                                        <li>
                                            <a href="#">Bonjour <?= $_SESSION['prenom'];?><i class="fas fa-chevron-down"></i></a>
                                            <ul>
                                                <li><a href="client/moncompte.php">Mon compte</a></li>
                                               
                                                    <li><a href="admin/destroy.php">Deconnexion</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-3 col-3 order-1">
                            <div class="logo_container">
                                <div class="logo"><a href="index.php">EasyFood</a></div>
                            </div>
                        </div>
                                ...
                                <div class="cart">
                                    <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                        <div class="cart_icon">
                                            ...
                                            <div class="cart_count"><span id="count"><?= $panier->count();?></span></div>
                                        </div>
                                        <div class="cart_content">
                                            <div class="cart_text"><a href="panier.php">Cart</a></div>
                                            <div class="cart_price"><span id="total"><?= number_format($panier->total(),2 );  ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul class="page_menu_nav">
                                    <li class="page_menu_item has-children">
                                        ...
                                        <ul class="page_menu_selection">
                                            <li><a href="#">Francais<i class="fa fa-angle-down"></i></a></li>

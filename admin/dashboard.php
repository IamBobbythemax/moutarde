...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <a class="navbar-brand" href="../">EasyFood</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" style="font-weight: bold;" aria-current="page" href="dashboard.php">Nouveau</a>
        </li>
        <li class="nav-item">
      ...
      <div style="margin-right: 500px">
        <h5 style="color: #545659; opacity: 0.5;">Connecté en tant que: <?= $_SESSION['prenom'];?> </h5>
      </div>
